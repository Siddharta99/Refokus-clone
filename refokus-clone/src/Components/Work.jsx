...
function Work() {
    ...
    const [images, setImages] = useState( [
        ...
        {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0acbc45cb2f4fc5c6b2_Yahoo.png", top:"45%", left: "54%", isActive: false},
        ...
        {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0ac7e7179d210dc41f0_Summon.png", top:"43%", left: "48%", isActive: false},
  ...
  return (
    <div className='w-full '>
        ...
        <div className='w-full h-full  absolute top-0'>
            {images.map((elem, index)=> (elem.isActive && (<img key={index} className='absolute w-40 rounded-lg -translate-x-[50%] -translate-y-[50%]' src={elem.url} style={{top: elem.top, left: elem.left}} alt=''/>))
            )}
        </div>
    </div>
  )
